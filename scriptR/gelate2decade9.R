...
gelate <-raster(paste(cartella,"ggelo_decade9_2002.asc",sep=""))
...
temporaneo <-raster(paste(cartella,"ggelo_decade9_",anno,".asc",sep=""))
...
writeRaster(gelate, file="../indici/gelate2decade9.asc", format="ascii", overwrite=T)
